...
0500000000`}
                ...
                <p className="admin-guest-accordion-lead">
                  לתפריט מידע (סיכום / עם אורחים / אולי / רשימות מלאות) שלחו למספר
                  המערכת: <strong>עזרה</strong> — כפתורים לחיצים (או מספרים), בלי
                  שליחת הודעות לאורחים. הרשימות מציגות את כל האורחים בבת אחת.
                </p>
                <p className="admin-guest-accordion-lead">
